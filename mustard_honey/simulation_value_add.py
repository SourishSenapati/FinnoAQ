...
- **Stability:** Syneresis Risk {self.jelly_stats.get('syneresis', 0.0):.2f}% (Safe).
...
"""
        with open("d:/PROJECT/FINNO PROJECTS/mustard_honey/TECHNICAL_REPORT_VALUE_ADD.md", "w", encoding="utf-8") as f:
            f.write(report)
