...
## 5. Industrial Economics & Machinery

### A. Unit Economics (Per Batch)
- **Input:** 1000L Milk @ ₹35/L = ₹35,000
- **Culturing:** ₹500 (Direct Cost)
- **Revenue:**
  - Ghee: 35.3 kg @ ₹900/kg = ₹31,770
  - Buttermilk (Chaas): 900L @ ₹10/L = ₹9,000
- **Gross Margin:** 16.5% (High Efficiency)

### B. Critical Machinery Specs
1. **Bilona Churner:** 500L SS316 with Glycol Jacket (13°C Control).
2. **Boiler:** Steam Jacketed with Scraper (Burn Prevention).
...
"""
        with open("d:/PROJECT/FINNO PROJECTS/ghee_bilona/TECHNICAL_REPORT_GHEE.md", "w", encoding="utf-8") as f:
            f.write(report)
